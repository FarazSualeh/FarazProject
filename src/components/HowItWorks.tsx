...
const translations = {
  en: {
    ...
    step3Title: "Step 3: Create Assignments & Notices",
    step3Desc: "Click on 'Create Assignment' or 'Send Notice' to share work with students. Select the subject, target grade, write your content, and optionally attach files. Assignments and notices are instantly sent to students in the selected grade.",
    
    step4Title: "Step 4: Monitor Student Progress",
    step4Desc: "Use the Analytics section to view detailed insights about each student's performance. Track quiz scores, game completions, learning streaks, and overall progress across all STEM subjects.",
    
    step5Title: "Step 5: Send Targeted Notifications",
    step5Desc: "Keep students engaged by sending targeted notices about upcoming quizzes, important announcements, or motivational messages. Students receive these in their inbox immediately.",
    
    step6Title: "Step 6: Review Analytics",
    step6Desc: "Access comprehensive analytics to understand student performance trends. Identify students who need extra help and those who are excelling. Use data to improve your teaching strategies.",
  ...
  hi: {
    ...
    step3Title: "चरण 3: असाइनमेंट और नोटिस बनाएं",
    step3Desc: "छात्रों के साथ काम साझा करने के लिए 'असाइनमेंट बनाएं' या 'नोटिस भेजें' पर क्लिक करें। विषय चुनें, लक्षित कक्षा चुनें, अपनी सामग्री लिखें, और वैकल्पिक रूप से फ़ाइलें संलग्न करें। असाइनमेंट और नोटिस तुरंत चयनित कक्षा में छात्रों को भेजे जाते हैं।",
    
    step4Title: "चरण 4: छात्र प्रगति की निगरानी करें",
    step4Desc: "प्रत्येक छात्र के प्रदर्शन के बारे में विस्तृत जानकारी देखने के लिए एनालिटिक्स अनुभाग का उपयोग करें। क्विज स्कोर, गेम पूर्णता, सीखने की लय और सभी STEM विषयों में समग्र प्रगति को ट्रैक करें।",
    
    step5Title: "चरण 5: लक्षित सूचनाएं भेजें",
    step5Desc: "आगामी क्विज़, महत्वपूर्ण घोषणाओं या प्रेरक संदेशों के बारे में लक्षित नोटिस भेजकर छात्रों को व्यस्त रखें। छात्रों को ये तुरंत उनके इनबॉक्स में प्राप्त होते हैं।",
    
    step6Title: "चरण 6: एनालिटिक्स की समीक्षा करें",
    step6Desc: "छात्र प्रदर्शन रुझानों को समझने के लिए व्यापक एनालिटिक्स तक पहुंचें। उन छात्रों की पहचान करें जिन्हें अतिरिक्त सहायता की आवश्यकता है और जो उत्कृष्ट प्रदर्शन कर रहे हैं। अपनी शिक्षण रणनीतियों को बेहतर बनाने के लिए डेटा का उपयोग करें।",
  ...
  od: {
    ...
    step3Title: "ପଦକ୍ଷେପ 3: ଆସାଇନମେଣ୍ଟ ଏବଂ ନୋଟିସ ସୃଷ୍ଟି କରନ୍ତୁ",
    step3Desc: "ଛାତ୍ରମାନଙ୍କ ସହିତ କାମ ସେୟାର କରିବା ପାଇଁ 'ଆସାଇନମେଣ୍ଟ ସୃଷ୍ଟି କରନ୍ତୁ' କିମ୍ବା 'ନୋଟିସ ପଠାନ୍ତୁ' ଉପରେ କ୍ଲିକ୍ କରନ୍ତୁ। ବିଷୟ ବାଛନ୍ତୁ, ଲକ୍ଷ୍ୟ ଶ୍ରେଣୀ ବାଛନ୍ତୁ, ଆପଣଙ୍କର ବିଷୟବସ୍ତୁ ଲେଖନ୍ତୁ, ଏବଂ ବୈକଳ୍ପିକ ଭାବରେ ଫାଇଲ ସଂଲଗ୍ନ କରନ୍ତୁ। ଆସାଇନମେଣ୍ଟ ଏବଂ ନୋଟିସ ତୁରନ୍ତ ଚୟନିତ ଶ୍ରେଣୀର ଛାତ୍ରମାନଙ୍କୁ ପଠାଯାଏ।",
    
    step4Title: "ପଦକ୍ଷେପ 4: ଛାତ୍ର ପ୍ରଗତି ନିରୀକ୍ଷଣ କରନ୍ତୁ",
    step4Desc: "ପ୍ରତ୍ୟେକ ଛାତ୍ରଙ୍କ ପ୍ରଦର୍ଶନ ବିଷୟରେ ବିସ୍ତୃତ ଜାଣିବା ପାଇଁ ଆନାଲିଟିକ୍ସ ବିଭାଗ ବ୍ୟବହାର କରନ୍ତୁ। କୁଇଜ୍ ସ୍କୋର, ଖେଳ ସମାପ୍ତି, ଶିଖିବା ଧାରା ଏବଂ ସମସ୍ତ STEM ବିଷୟରେ ସାମଗ୍ରିକ ପ୍ରଗତି ଟ୍ରାକ୍ କରନ୍ତୁ।",
    
    step5Title: "ପଦକ୍ଷେପ 5: ଲକ୍ଷ୍ୟିତ ବିଜ୍ଞପ୍ତି ପଠାନ୍ତୁ",
    step5Desc: "ଆସୁଥିବା କୁଇଜ୍, ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ ଘୋଷଣା କିମ୍ବା ପ୍ରେରଣାଦାୟକ ସନ୍ଦେଶ ବିଷୟରେ ଲକ୍ଷ୍ୟିତ ନୋଟିସ ପଠାଇ ଛାତ୍ରମାନଙ୍କୁ ବ୍ୟସ୍ତ ରଖନ୍ତୁ। ଛାତ୍ରମାନେ ତୁରନ୍ତ ସେମାନଙ୍କ ଇନବକ୍ସରେ ଏହା ପାଆନ୍ତି।",
    
    step6Title: "ପଦକ୍ଷେପ 6: ଆନାଲିଟିକ୍ସର ସମୀକ୍ଷା କରନ୍ତୁ",
    step6Desc: "ଛାତ୍ର ପ୍ରଦର୍ଶନ ଧାରା ବୁଝିବା ପାଇଁ ବ୍ୟାପକ ଆନାଲିଟିକ୍ସ ଉପଲବ୍ଧ କରନ୍ତୁ। ଯେଉଁ ଛାତ୍ରମାନଙ୍କୁ ଅତିରିକ୍ତ ସାହାଯ୍ୟ ଆବଶ୍ୟକ ଏବଂ ଯେଉଁମାନେ ଉତ୍କୃଷ୍ଟ ପ୍ରଦର୍ଶନ କରୁଛନ୍ତି ସେମାନଙ୍କୁ ଚିହ୍ନଟ କରନ୍ତୁ। ଆପଣଙ୍କର ଶିକ୍ଷଣ ରଣନୀତି ଉନ୍ନତ କରିବା ପାଇଁ ତଥ୍ୟ ବ୍ୟବହାର କରନ୍ତୁ।",
